...
function Details3 () {
    ...
    <div class="container">
        ...
        <img src="images/DK-1.jpeg" alt=""/>
    </div>

    <div class="imgslide fade">
        <div class="numberslide"></div>
        <img src="images/DK-2.jpg" alt=""/>
    </div>

    <div class="imgslide fade">
        <div class="numberslide"></div>
        <img src="images/DK-3.jpg" alt=""/>
    </div>

    <div class="imgslide fade">
        <div class="numberslide"></div>
        <img src="images/DK-4.JPG" alt=""/>
    </div>

    <div class="imgslide fade">
        <div class="numberslide"></div>
        <img src="images/DK-5.jpg" alt=""/>
    </div>

    <div class="imgslide fade">
        <div class="numberslide"></div>
        <img src="images/DK-6.jpg" alt=""/>
    </div>
...
<div class="page">
    ...
    <div class="titfac" id="details1">
        <h3 class="section-tittle2">Deluxe King Facilities</h3>
